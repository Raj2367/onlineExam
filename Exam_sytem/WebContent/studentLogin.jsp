...
<body>
    ...
    <div class="container border shadow-none p-3 mb-5 bg-light rounded">
        <div class="row">
            <div class="col-sm">
                <img src="https://en.es-static.us/upl/2018/12/comet-wirtanen-Jack-Fusco-dec-2018-Anza-Borrego-desert-CA-e1544613895713.jpg" class="img-fluid" alt="Responsive image">
            </div><br>
            <div class="col-sm">
